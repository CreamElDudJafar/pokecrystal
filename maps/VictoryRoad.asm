...
VictoryRoad_MapEvents:
	...
	object_event  3, 44, SPRITE_NONE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, VictoryRoadMaxRevive, EVENT_VICTORY_ROAD_MAX_REVIVE
	...
	object_event  5, 44, SPRITE_NONE, SPRITEMOVEDATA_STRENGTH_BOULDER, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, VictoryRoadFullHeal, EVENT_VICTORY_ROAD_FULL_HEAL
