...
RadioTower4F_MapEvents:
	...
	object_event 12,  6, SPRITE_ROCKET, SPRITEMOVEDATA_STANDING_UP, 2, 0, -1, -1, 0, OBJECTTYPE_TRAINER, 6, TrainerExecutivem2, EVENT_RADIO_TOWER_ROCKET_TAKEOVER
	...
	object_event  9,  6, SPRITE_SCIENTIST, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 6, TrainerScientistRich, EVENT_RADIO_TOWER_ROCKET_TAKEOVER
