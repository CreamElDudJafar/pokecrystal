...
TeamRocketBaseB2FHiddenFullHeal:
	hiddenitem LUCKY_EGG, EVENT_TEAM_ROCKET_BASE_B2F_HIDDEN_FULL_HEAL
...
TeamRocketBaseB2F_MapEvents:
	...
	object_event 24, 11, SPRITE_ROCKET, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_TRAINER, 6, TrainerGruntM17, EVENT_TEAM_ROCKET_BASE_POPULATION
	...
	object_event 21, 14, SPRITE_ROCKET, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, 0, OBJECTTYPE_TRAINER, 8, TrainerGruntM19, EVENT_TEAM_ROCKET_BASE_POPULATION
