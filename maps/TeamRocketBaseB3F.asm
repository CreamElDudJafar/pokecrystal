...
TeamRocketBaseB3F_MapEvents:
	...
	object_event 21,  7, SPRITE_ROCKET, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, 0, OBJECTTYPE_TRAINER, 0, RaticateTailGrunt, EVENT_TEAM_ROCKET_BASE_POPULATION
	object_event  1,  2, SPRITE_SCIENTIST, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 3, TrainerScientistRoss, EVENT_TEAM_ROCKET_BASE_POPULATION
	object_event 26, 12, SPRITE_SCIENTIST, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 6, TrainerScientistMitch, EVENT_TEAM_ROCKET_BASE_POPULATION
